...
begin
  for target_function in
    ...
    where n.nspname = 'public'
      and p.proname = 'validar_regla_contable'
  loop
...
begin
  ...
  if clean_modulo = 'compras' then
    ...
    where regla.activa is true
      ...
      and (
        (p_organization_id is not null and regla.organization_id = p_organization_id)
        or (p_organization_id is null and regla.organization_id is null)
      )
